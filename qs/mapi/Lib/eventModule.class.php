...
class eventApiModule extends MainBaseApiModule
{
    ...
    public function index(){
        ...
        $event_info = $event_info?format_event_item($event_info):array();
        $root['event_info'] = $event_info;
        $root['dp_list'] = $dp_list?format_dp_list($dp_list):array();


        $root['share_title'] = $event_info['name'];
        $root['share_img'] = $event_info['img'];
        $root['share_content'] = $event_info[''];
        $root['share_url'] = $event_info['share_url'];
