...
class uc_scoreApiModule extends MainBaseModule
{
    ...
    public function buy_score()
    {
        ...
        $root['SCORE_RECHARGE_USABLE_SCORE'] = app_conf("SCORE_RECHARGE_USABLE_SCORE");
        $root['SCORE_RECHARGE_FROZEN_SCORE'] = app_conf("SCORE_RECHARGE_FROZEN_SCORE");
        $root['default_first_money']= $root['score_number_array'][0];
        $root['default_first_frozen_score']=$root['score_number_array'][0]*$root['SCORE_RECHARGE_USABLE_SCORE'];
        $root['default_first_usable_score']=$root['score_number_array'][0]*$root['SCORE_RECHARGE_FROZEN_SCORE'];
