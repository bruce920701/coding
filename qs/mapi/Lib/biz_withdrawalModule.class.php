...
class biz_withdrawalApiModule extends MainBaseApiModule
{
    ...
    public function submit_form(){
		...
		$result=get_supplier_withdraw_money($account_info['supplier_withdraw_cycle'],$account_info['supplier_id']);
        $money=floatval($supplier_info['money'])-$submit_money-$result;
