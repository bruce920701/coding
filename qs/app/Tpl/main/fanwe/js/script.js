...
function form_err(ipt,txt){
	$(ipt).parent().parent().find(".success-ico").html("");
	$(ipt).parent().parent().find(".form_tip").html("<span class='error'>"+txt+"</span>");
}
function form_success(ipt,txt){
	if(txt!="")
	$(ipt).parent().parent().find(".success-ico").html("<span class='success'>"+txt+"</span>");
	else
		$(ipt).parent().parent().find(".success-ico").html("<span class='success'>&nbsp;</span>");
}
...
function nav_show()
{
	...
	if(nav.length>0){
		...
		if($(window).width()<max_length) max_length=$(window).width();
