...
class uc_tuanModule extends MainBaseModule
{
	public function index()
	{
		...
		foreach($list as $k=>$v) {
			...
			$list[$k]['total_price_format'] = $v['total_price'];
	...
	public function view()
	{
		...
		if($order_info) {
			...
			$order_info['deal_total_price_format'] = $order_info['deal_total_price']-$order_info['discount_price'];
			$order_info['total_price_format'] = $order_info['total_price'];
			$order_info['delivery_fee_format'] = $order_info['delivery_fee'];
			$order_info['ecv_money_format'] = $order_info['ecv_money'];
			//$order_info['discount_price_format'] = $order_info['discount_price'];
