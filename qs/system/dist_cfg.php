...
return array(
		...
		//必须修改 system/alioss/sdk.class.php 中的 DEFAULT_OSS_HOST
        "OSS_DIRECTORY" => '',//二级目录配置，如果存在如ilvbo2o 域名也要跟上二级目录
		"OSS_DOMAIN"	=>	'',  //远程存储域名http://img.fanwe.net/ilvbo2o
		"OSS_FILE_DOMAIN"	=>	'',	//远程存储文件域名(主要指脚本与样式)http://img.fanwe.net/ilvbo2o
		"OSS_BUCKET_NAME"	=>	'', //针对阿里oss的bucket_name
		"OSS_ACCESS_ID"	=>	'',
		"OSS_ACCESS_KEY"	=>	'',
		
		"CACHE_TYPE" => "File", //File 文件缓存,MemcacheSASL 缓存
		"CACHE_LOG" => false,
		"SESSION_TYPE" => "File",//File 文件缓存,MemcacheSASL 缓存
		"ALLOW_DB_DISTRIBUTE" => false,
		"CSS_JS_OSS" => false,
		"OSS_TYPE" => '',
		"DOMAIN_ROOT" => "",
		"COOKIE_PATH" => "/",
		"ORDER_DISTRIBUTE_COUNT" => 1,
);
