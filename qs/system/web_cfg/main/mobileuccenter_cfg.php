...
return array(
			"OrderManager"	=>	array(
					...
					"menu"	=>	array(
							...
							array("name"=>"预订单","type"=>404,"module"=>"dc_rsorder","action"=>"index",'data'=>array(),'num'=>0),
							array("name"=>"服务单","type"=>450,"module"=>"vs_order","action"=>"index",'data'=>array(),'num'=>0),
			...
			"fx_nav"	=>	array(
					"name"	=>	"{$GLOBALS['lang']['WAP_USER_CENTER_FX_NAME']}管理",
					"layout_type"=>	1,
					"menu"	=>	array(
							array("name"=>"{$GLOBALS['lang']['WAP_USER_CENTER_UC_FX']}","type"=>407,"module"=>"uc_fx","action"=>"index",'data'=>array(),'num'=>0,'imgKey' => 'uc_fx'),
							array("name"=>"市场","type"=>408,"module"=>"uc_fx","action"=>"shop_fx",'data'=>array(),'num'=>0,'imgKey' => 'deal_fx'),
							array("name"=>"{$GLOBALS['lang']['WAP_USER_CENTER_UC_FXWITHDRAW']}","type"=>409,"module"=>"uc_fxwithdraw","action"=>"index",'data'=>array(),'num'=>0,'imgKey' => 'uc_fxwithdraw'),
							array("name"=>"推荐","type"=>410,"module"=>"uc_fxinvite","action"=>"index",'data'=>array(),'num'=>0,'imgKey' => 'uc_fxinvite')
					),
					"list"	=>	array(
							array("name"=>"{$GLOBALS['lang']['WAP_USER_CENTER_FX_NAME']}管理","type"=>411,"module"=>"uc_fx","action"=>"vip_buy",'data'=>array(),'tip'=>"开通{$GLOBALS['lang']['WAP_USER_CENTER_FX_NAME']}资格"),
					),
			),
			"Service"	=>	array(
					"name"	=>	"会员服务",
					"layout_type"=>	2,
					"list"	=>	array(
						   	array("name"=>"商家入驻","type"=>603,"module"=>"supplier","action"=>"index",'data'=>array(),'tip'=>''),
			...
			"Administration"	=>	array(
					...
					"list"	=>	array(
							...
							array("name" => "客服中心", "type" => 416, "module" => "help", "action" => "index", 'data' => array(), 'tip' => '')
					)
			),
