...
class Dc_Aliapp_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$notify_url = SITE_DOMAIN.APP_ROOT.'/callback/dc_payment/aliapp_notify.php';
...
//		print_r($pay);exit;
		$pay['sdk_code'] = array("pay_sdk_type"=>"alipay","config"=>array("order_spec"=>addslashes($order_spec),"sign"=>urlencode($sign),"sign_type"=>"RSA"));
		return $pay;
	}
	...
	{	
		...
		//file_put_contents(APP_ROOT_PATH."/system/dc_payment/Aliapp/alipaylog/ealipay_".date("Y-m-dHis").".txt",print_r($_REQUEST,true));
		
		require_once(APP_ROOT_PATH.'system/dc_payment/Aliapp/alipay_notify.class.php');
