...
class Dc_WxApp_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$data_notify_url = SITE_DOMAIN.APP_ROOT.'/callback/dc_payment/wxapp_notify.php';

		require_once(APP_ROOT_PATH.'system/dc_payment/Wxapp/WxPay.Api.php');
		require_once(APP_ROOT_PATH.'system/dc_payment/Wxapp/WxPay.Notify.php');
		require_once(APP_ROOT_PATH.'system/dc_payment/Wxapp/WxPay.Data.php');
