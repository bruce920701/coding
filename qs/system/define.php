...
define("IS_VISITING_SERVICE",0);//上门服务开关

// 开启小能聊天功能
define('OPEN_XN_TALK', true);

define('ENTRY_NAME', 'cssh_o2o');//cssh_o2o:城市生活o2o，nzy_o2o:鸟之鱼o2o

define('WAP_DEAL_TAG_NUMBER', 16);
define('PC_DEAL_TAG_NUMBER', 10);

// jdk定时器调用地址
define('JDK_REQUEST_URL','localhost');
