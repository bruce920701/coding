...
return array(
			...
			"Order"	=>	array(
					...
					"node"	=>	array(
                            ...
                            "deal_presell_order"=>array("name"=>"预售订单","module"=>"deal_presell_order","action"=>"index", "is_pc"=>1),
					)
			),
            ...
            "Promote"	=>	array(
                "name"	=>	"营销管理",
                "node"	=>	array(
                    "promote"=>array("name"=>"满免运费","module"=>"promote","action"=>"index","is_pc"=>1),
                    "deal_presell"=>array("name"=>"商品预售","module"=>"deal_presell","action"=>"index","is_pc"=>1),
                ),
            )
