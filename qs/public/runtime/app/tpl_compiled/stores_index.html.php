...
$k = array (
  ...
  'v' => $this->_var['store_item']['json_url'],
  's' => '3',
);
echo $k['name']($k['v'],$k['s']);
?>" /> </td></tr></table>
...
?>
				<li class="side_row">
                    <!--qr码扫描区-->
                    <div rel="qrcode" class="scan_store_list">
                            <a class="scan_outter" href="<?php echo $this->_var['side_store']['url']; ?>" title="<?php echo $this->_var['side_store']['name']; ?>">
                            <table><tr><td><img src="<?php 
$k = array (
  'name' => 'gen_scan_qrcode',
  'v' => $this->_var['side_store']['json_url'],
  's' => '3',
);
echo $k['name']($k['v'],$k['s']);
?>" /> </td></tr></table>
                    ...
                    <!--end qr码扫描区-->
					<a href="<?php echo $this->_var['side_store']['url']; ?>" class="deal_img">
					    <img src="<?php 
$k = array (
  'name' => 'get_spec_image',
