...
echo parse_url_tag("u:index|dc_consignee#add|"."".""); 
...
?>
							<tr class="alt">
									...
									<td class="region"><?php echo $this->_var['item']['api_address']; ?></td>
									<td><?php echo $this->_var['item']['address']; ?></td>	
									<td class="mobile" width="80"><?php echo $this->_var['item']['mobile']; ?></td>
									<td class="operate" style="width:120px;*width:150px;">
											<a href="<?php
echo parse_url_tag("u:index|dc_consignee#add|"."id=".$this->_var['item']['id']."".""); 
?>">修改</a>
											<?php if ($this->_var['item']['is_main'] == 1): ?><span>默认地址</span><?php else: ?><a href="javascript:void(0);" class="default" dfurl="<?php echo $this->_var['item']['dfurl']; ?>">设为默认</a><?php endif; ?>											
