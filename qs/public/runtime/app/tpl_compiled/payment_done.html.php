...
?>" class="lottery_invite"><?php echo $this->_var['LANG']['GET_INVITE_LOTTERY']; ?></a>
						...
						<div class="order_share_box">
							<div class="order_o_checkbox f_l"><label class="ui-checkbox" rel="common_cbo"><input type="checkbox" name="is_share" value="1" url_data="<?php if ($this->_var['order_info']['is_main'] == 1): ?><?php
echo parse_url_tag("u:index|uc_order|"."".""); 
?><?php elseif ($this->_var['order_info']['is_shop'] == 1): ?><?php
echo parse_url_tag("u:index|uc_order#view|"."id=".$this->_var['order_info']['id']."".""); 
?><?php else: ?><?php
echo parse_url_tag("u:index|uc_tuan#view|"."id=".$this->_var['order_info']['id']."".""); 
?><?php endif; ?>" checked="true"/>分享到个人中心</label></div>
