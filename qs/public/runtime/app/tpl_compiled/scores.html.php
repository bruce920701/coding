...
$this->_var['pagejs'][] = $this->_var['TMPL_REAL']."/js/page_js/scores.js";
$this->_var['cpagejs'][] = $this->_var['TMPL_REAL']."/js/page_js/scores.js";
?>
...
?><i>积分</i></span>
					...
					<div class="deal_extra">
						<div class="sale_count">
							已兑换<span><?php echo $this->_var['deal']['buy_count']; ?></span>
						</div>
