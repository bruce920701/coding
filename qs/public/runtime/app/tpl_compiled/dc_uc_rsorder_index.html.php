...
?>" lazy="true" class="deal_icon" /></a>
	                                ...
	                                <td>
                             		<?php echo $this->_var['order']['location_name']; ?>  	
									</td>
	                                <td>
	                             	 <?php echo $this->_var['order']['total_price']; ?>
	                                </td>
	                                <td>
...
?>
	                                <?php echo $this->_var['order_menu']['table_time_format']; ?>
									...
									<td class="op_box">		
										<a href="<?php
echo parse_url_tag("u:index|dc_rsorder#view|"."id=".$this->_var['order']['id']."".""); 
?>">查看</a>
										<?php if ($this->_var['order']['is_cancel'] == 0): ?>		
											<?php if ($this->_var['order']['pay_status'] != 1): ?>  
...
?>" class="tip_color verify_delivery">电子凭证</a>
												-->
											...
											<?php if ($this->_var['order']['order_status'] == 0 && $this->_var['order']['confirm_status'] != 2 && $this->_var['order']['refund_status'] == 0): ?> 
												<a href="javascript:void(0);" action="<?php
echo parse_url_tag("u:index|dc_rsorder#cancel|"."id=".$this->_var['order']['id']."".""); 
...
echo parse_url_tag("u:index|dcres|"."".""); 
?>">马上去预订</a></div>
			<?php endif; ?>
		</div>
	</div>	
