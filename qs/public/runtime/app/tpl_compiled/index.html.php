...
$k = array (
  ...
  'v' => $this->_var['store']['json_url'],
);
echo $k['name']($k['v']);
?>" width=123 height=123 /> </td></tr></table>
					<div></div>
				</a>
				</div>
				<!--end qr码扫描区-->
...
?>" /></a>
						...
						<div class="tuan_price">
							<span class="current_price"><small style="font-size: 12px;">所需积分:</small><?php 
$k = array (
  'name' => 'round',
  'v' => $this->_var['deal']['current_price'],
  'l' => '2',
