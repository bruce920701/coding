...
?>" title="" target="_blank"><?php echo $this->_var['mainDeal']['name']; ?></a> 
			...
			<div class="p-price ac"> 
				...
				<label class="ui-checkbox" rel="common_cbo">
					<input type="checkbox" name="relateCheckbox" value="<?php echo $this->_var['mainDeal']['id']; ?>" id="main_goods" />
					<strong><?php 
$k = array (
  'name' => 'round',
...
?></strong>
               	...
               	<?php else: ?>
				<input type="checkbox" name="relateCheckbox" value="<?php echo $this->_var['mainDeal']['id']; ?>" style="display:none;" checked="true" id="main_goods" />
				<strong><?php 
$k = array (
  'name' => 'round',
  'v' => $this->_var['mainDeal']['current_price'],
...
echo $k['name']($k['v'],$k['l']);
?></strong><small style="font-size: 12px;">积分</small>
			    <?php endif; ?>
...
?>" title="" target="_blank"><?php echo $this->_var['deal']['name']; ?></a> 
			...
			<div class="p-price ac"> 
				<label class="ui-checkbox" rel="common_cbo">
					<input type="checkbox" name="relateCheckbox"  value="<?php echo $this->_var['deal']['id']; ?>"/>
					<strong><?php 
$k = array (
  'name' => 'round',
...
?></strong> 
		...
		<div class="relate-price-box">
			...
			<div class="relate-check-price" >搭 配 积 分：<span id="relateCheckCurrPrice">0.00</span><br /><span style="text-decoration:line-through;">参 考 积 分：<span id="relateCheckOrigPrice">0.00</span></span></div>
