...
?>
				<dd id="<?php echo $this->_var['row']['id']; ?>" class="deal-item">
					<a href="<?php echo $this->_var['row']['url']; ?>" title="<?php echo $this->_var['row']['name']; ?>" target="_blank"  class="deal-link" ><img class="deal-cover" src="<?php if ($this->_var['row']['icon'] == ''): ?>public/images/no-image.png<?php else: ?><?php echo $this->_var['row']['icon']; ?><?php endif; ?>" width="80" height="50"></a>
