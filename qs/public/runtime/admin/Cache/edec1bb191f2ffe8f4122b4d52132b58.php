<?php if (!defined('THINK_PATH')) exit();?><!--index_zt4_p1-->
<!--index_zt4_p2-->
<!--index_zt4_p3-->
<!--index_zt4_p4-->
<!--index_zt4_p5-->
...
.m-shopping .tit-hasimg .right{
	...
	float: right;
	color: #ff2244;
	background: url(<?php echo ($TMPL); ?>images/icon-right.png) right center no-repeat;
	background-size: 10%;
	padding-right: .8rem;
}
...
.blank{height: 0;visibility: hidden;clear: both;overflow: hidden;}
	...
	<div class="m-shopping">
		...
		<div class="shopping-bottom-list b-line">
			...
			<div class="shopping-bottom-item small r-line">
				<a href="javascript:void(0);" class="zt_moban"><img class="<?php echo ($zt_moban); ?>_p7" alt="" src="<?php echo $zt_img_data[$zt_moban.'_p7']['img'] ?>" />
				<input type="hidden" name="type" value="<?php echo $zt_img_data[$zt_moban.'_p7']['type'] ?>" />
				<input type="hidden" name="ctl_name" value="<?php echo $zt_img_data[$zt_moban.'_p7']['ctl_name'] ?>" />
				<input type="hidden" name="ctl_value" value="<?php echo $zt_img_data[$zt_moban.'_p7']['ctl_value'] ?>" />
				</a>
			</div>
			<div class="shopping-bottom-item small">
				<a href="javascript:void(0);" class="zt_moban"><img class="<?php echo ($zt_moban); ?>_p8" alt="" src="<?php echo $zt_img_data[$zt_moban.'_p8']['img'] ?>" />
				<input type="hidden" name="type" value="<?php echo $zt_img_data[$zt_moban.'_p8']['type'] ?>" />
				<input type="hidden" name="ctl_name" value="<?php echo $zt_img_data[$zt_moban.'_p8']['ctl_name'] ?>" />
				<input type="hidden" name="ctl_value" value="<?php echo $zt_img_data[$zt_moban.'_p8']['ctl_value'] ?>" />
				</a>
			</div>
			<div class="blank"></div>
		</div>
