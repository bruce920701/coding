...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(10).14(4(){M();c();$("k[7=\'R\']").h("11",4(){D()});Q()});4 D(){a x=$("k[7=\'R\']").q();a U=12[x];9(x==0){a j="<e s=\'0\'>==城市</e>"}o{a m=U[\'13\'];a j="<e s=\'0\'>==城市</e>";15(t 16 m){j+="<e s=\'"+m[t][\'v\']+"\'>"+m[t][\'7\']+"</e>"}}$("k[7=\'u\']").j(j)}4 Q(){$("Z[7=\'1d\']").h("G",4(){9($("k[7=\'u\']").q()!=0)N.X=$("k[7=\'u\']").q();F H})}4 M(){$(".E").y(4(){$(".E").d("8");$(f).l("8")},4(){$(f).d("8")})}4 Y(){$(".3 6 5").y(4(){$(".3 6 5").d("8");$(f).l("8")},4(){$(f).d("8")})}4 c(){a 2=g;a K=$("i[7=\'c\']").V().J;a I=$("i[7=\'c\']").V().L;$(".3").r({J:K+1g,L:I});$("i[7=\'c\']").h("1k",4(w){$(".3").p();a n=$("i[7=\'c\']").q();9(n!=""){$(".3 6 5").T();$(".3 6 5[1f*=\'"+n+"\']").p();$(".3 6 5[1i*=\'"+n+"\']").p();$(".3").r(\'W\',\'1j\')}o{$(".3 6 5").p();$(".3").r(\'W\',\'1h\')}Y();9(w.P==1e){$(\'.3 6 5\').d("8");9(2==g){2=$(\'.3 6 5:b\').z()}o{2=$(2).17("5:b")}9(2.C==0){2=$(\'.3 6 5:b\').z()}$(2).l("8")}9(w.P==19){$(\'.3 6 5\').d("8");9(2==g){2=$(\'.3 6 5:b\').S()}o{2=$(2).18("5:b")}9(2.C==0){2=$(\'.3 6 5:b\').S()}$(2).l("8")}});$(\'.3 6 5\').y(4(){$(\'.3 6 5\').d("8");2=$(f);$(2).l("8")},4(){$.A()});$("i[7=\'c\']").h("1a",4(){9(2==g&&$(\'.3 6 5:b\').C==1){2=$(\'.3 6 5:b\').z()}$(".3").T();$.A()});$(\'.3 6 5\').h("1b",4(){2=$(f);$.B()});$("Z[7=\'1c\']").h("G",4(){$.B();F H});$.A=4(){2=g};$.B=4(){9(2!=g&&2.O("v"))N.X=2.O("v")}}',62,83,'||current_li|search_list|function|li|ul|name|cur|if|var|visible|search_city|removeClass|option|this|null|bind|input|html|select|addClass|regionConfs|keyword|else|show|val|css|value|key|city|url|event|id|hover|first|clear_city|jump_city|length|load_select|city_names|return|submit|false|city_left|top|city_top|left|city_py_hover|location|attr|keyCode|select_jump|province|last|hide|evalStr|offset|height|href|search_hover|form|document|change|city_json|city_list|ready|for|in|next|prev|38|blur|mousedown|search_city_form|city_province|40|suname|36|280px|sname|auto|keyup'.split('|'),0,{}))
