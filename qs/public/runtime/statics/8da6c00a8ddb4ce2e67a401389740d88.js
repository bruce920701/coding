...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(i).k(4(){$(".7 l").e(d,4(){5 2=c($(3).8());b(2-1<=0){2=0;$(3).f();5 9=$(".7 a").g("6");h.6=9}j{2=2-1}$(3).8(2)})});',22,22,'||t|this|function|var|href|jump_tip|html|jump||if|parseInt|1000|everyTime|stopTime|attr|location|document|else|ready|span'.split('|'),0,{}))
