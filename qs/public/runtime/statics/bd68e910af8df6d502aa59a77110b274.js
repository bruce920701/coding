...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(1Y).29(d(){1D();1r()});d 1r(){b M="<L 11=\'0\'>所在省份</L>";1F(b i 1v 16){M+="<L 11=\'"+16[i].i+"\'>"+16[i].n+"</L>"}$(".1p").M(M);$(".1p").x(d(){$(f).1y({1z:w})})}d 1s($F,10){b 1q=10;b F=16["r"+10][\'c\'];5(1q==0){b M="<L 11=\'0\'>所在城市</L>"}v{b M="<L 11=\'0\'>所在城市</L>";1F(b 1i 1v F){M+="<L 11=\'"+F[1i].i+"\'>"+F[1i].n+"</L>"}}$F.M(M);$F.1y({1z:w})}d 1D(){$("W[3=\'1j\']").A("27",d(){1s($(f).1b().1T().2("W"),$(f).j())});$(".p-1u a").28("17",d(){b V=$(f).e("2a");b H=$(f).e("H");$(".p-t[H=\'"+V+"\']").2(".t").1M();$(".p-t[H=\'"+V+"\']").2(".t[H=\'"+H+"\']").1L();$(".p-1u[H=\'"+V+"\']").2("a").23("1A");$(f).1Z("1A")});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'E\']").e("D")){$(8).2("7[3=\'E\']").e("D",w);$(8).2("7[3=\'E\']").A("Q",d(){S($(f))})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'E\']").e("G")){$(8).2("7[3=\'E\']").e("G",w);$(8).2("7[3=\'E\']").A("X",d(){b m=$(f).j();b P=$(f);5($.h(m)==""){u($(f),"请输入邮箱账号")}v 5(!$.1P($.h(m))){B($(f),"邮箱格式不正确")}v{1e("E",m,0,P)}})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'J\']").e("D")){$(8).2("7[3=\'J\']").e("D",w);$(8).2("7[3=\'J\']").A("Q",d(){S($(f))})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'J\']").e("G")){$(8).2("7[3=\'J\']").e("G",w);$(8).2("7[3=\'J\']").A("X",d(){b m=$(f).j();b P=$(f);5($.h(m)==""){B($(f),"请输入用户名")}v{b 1x=1l 1w("^(?!12)(?!.*?12$)[a-21-25-2b\\2q-\\2o]+$");b 1B=1l 1w("^[0-9]*$");5(!1x.1E(m)){B($(f),\'支持中文、字母、数字、“12” 且不能以"12" 开头和结尾\')}v 5(m.18<4||m.18>20){B($(f),\'必须 4-20 个字符\')}v 5(1B.1E(m)){B($(f),\'不能为纯数字\')}v{1e("J",m,0,P)}}})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'z\']").e("D")){$(8).2("7[3=\'z\']").e("D",w);$(8).2("7[3=\'z\']").A("Q",d(){S($(f))})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'z\']").e("G")){$(8).2("7[3=\'z\']").e("G",w);$(8).2("7[3=\'z\']").A("X",d(){b m=$(f).j();5($.h(m)==""){u($(f),"请输入密码")}v 5(m.18<6||m.18>20){u($(f),"必须 6-20 个字符")}})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'y\']").e("D")){$(8).2("7[3=\'y\']").e("D",w);$(8).2("7[3=\'y\']").A("Q",d(){S($(f))})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'y\']").e("G")){$(8).2("7[3=\'y\']").e("G",w);$(8).2("7[3=\'y\']").A("X",d(){b m=$(f).j();b H=$(f).e("H");b 1C=$(8).2("7[3=\'z\'][H=\'"+H+"\']").j();5($.h(m)==""){u($(f),"请输入确认密码")}v 5($.h(m)!=$.h(1C)){B($(f),"您两次输入的密码不匹配")}v{2m($(f),"")}})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'N\']").e("D")){$(8).2("7[3=\'N\']").e("D",w);$(8).2("7[3=\'N\']").A("Q",d(){S($(f))})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'C\']").e("D")){$(8).2("7[3=\'C\']").e("D",w);$(8).2("7[3=\'C\']").A("Q",d(){S($(f))})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'C\']").e("G")){$(8).2("7[3=\'C\']").e("G",w);$(8).2("7[3=\'C\']").A("X",d(){b m=$(f).j();b P=$(f);5($.h(m)==""){u($(f),"请输入手机号")}v 5(!$.1k(m)){B($(f),"手机号格式不正确")}v{1e("Y",m,0,P)}})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'K\']").e("D")){$(8).2("7[3=\'K\']").e("D",w);$(8).2("7[3=\'K\']").A("Q",d(){S($(f))})}});$(".p-t").x(d(k,8){5(!$(8).2("7[3=\'K\']").e("G")){$(8).2("7[3=\'K\']").e("G",w);$(8).2("7[3=\'K\']").A("X",d(){b m=$(f).j();b P=$(f);5($.h(m)==""){u($(f),"请输入收到的验证码")}})}});1X();$(".p-t").x(d(k,8){5(!$(8).2("1o.13").e("1t")){$(8).2("1o.13").e("1t",w);$(8).2("1o.13").A("17",d(){5($(f).e("H")=="2i")s q;b 1S=$(f).e("V")+"2d";b g=$("g[3=\'"+1S+"\']");b 1Q=$(f);b I=1l 2j();I.2k="2l";b Y=$(g).2("7[3=\'C\']").j();5($.h(Y)==""){u($(g).2("7[3=\'C\']"),"请输入手机号");s q}5(!$.1k(Y)){B($(g).2("7[3=\'C\']"),"手机号格式不正确");s q}I.Y=$.h(Y);I.1U=$.h($(g).2("7[3=\'1U\']").j());I.N=$.h($(g).2("7[3=\'N\']").j());I.2h=1;$.1n({U:2g,1f:"1g",l:I,1h:"1d",2c:q,1a:d(l){5(l.1c){1V(1Q,l.R);2n=w;$(g).2("2e.1W").17();5(l.2f>1){$(g).2(".1G").1L()}v{$(g).2(".1G").1M()}}v{5(l.Z){B($(g).2("7[3=\'"+l.Z+"\']"),l.O)}v $.1m(l.O)}}})})}});$(".p-t").2(".p").x(d(i,g){5(!$(g).e("19")){$(g).e("19",w);$(g).A("1N",d(){b E=$(g).2("7[3=\'E\']");5($.h(E.j())==""){u(E,"请输入邮箱账号");s q}5(!$.1P(E.j())){B(E,"邮箱格式不正确");s q}b J=$(g).2("7[3=\'J\']");5($.h(J.j())==""){u(J,"请输入用户名");s q}b z=$(g).2("7[3=\'z\']");5($.h(z.j())==""){u(z,"请输入密码");s q}b y=$(g).2("7[3=\'y\']");5($.h(y.j())==""){u(y,"请输入确认密码");s q}5($.h(y.j())!=$.h(z.j())){B(y,"您两次输入的密码不一致");s q}b $T=$(g).2("W[3=1j]");5($.h($T.j())==0){u($T,"请选择省份");s q}b $F=$(g).2("W[3=10]");5($.h($F.j())==0){u($F,"请选择城市");s q}b N=$(g).2("7[3=\'N\']");5($.h(N.j())==""){u(N,"请输入图片文字");s q}b U=$(g).e("1O");b I=$(g).1H();$.1n({U:U,1h:"1d",l:I,1f:"1g",1a:d(l){5(l.1c){$.1I(l.O,d(){1R.1J=l.1K})}v{5(l.Z){B($(g).2("7[3=\'"+l.Z+"\']"),l.O)}v $.1m(l.O)}}});s q})}});$(".p-t").2(".2r").x(d(i,g){5(!$(g).e("19")){$(g).e("19",w);$(g).A("1N",d(){b C=$(g).2("7[3=\'C\']");5($.h(C.j())==""){u(C,"请输入手机号");s q}5(!$.1k(C.j())){B(C,"手机号格式不正确")}b K=$(g).2("7[3=\'K\']");5($.h(K.j())==""){u(K,"请输入收到的验证码");s q}b z=$(g).2("7[3=\'z\']");5($.h(z.j())==""){u(z,"请输入密码");s q}b y=$(g).2("7[3=\'y\']");5($.h(y.j())==""){u(y,"请输入确认密码");s q}5($.h(y.j())!=$.h(z.j())){B(y,"您两次输入的密码不匹配");s q}b $T=$(g).2("W[3=1j]");5($.h($T.j())==0){u($T,"请选择省份");2p.22($T.1b().1b().2(".u"));s q}b $F=$(g).2("W[3=10]");5($.h($F.j())==0){u($F,"请选择城市");s q}b U=$(g).e("1O");b I=$(g).1H();$.1n({U:U,1h:"1d",l:I,1f:"1g",1a:d(l){5(l.1c){$.1I(l.O,d(){1R.1J=l.1K})}v{$(g).2(".1W").17();5(l.Z){B($(g).2("7[3=\'"+l.Z+"\']"),l.O)}v $.1m(l.O)}}});s q})}})}d 1X(){$(".p-t").2("26.13[14!=\'14\']").x(d(i,o){$(o).e("14","14");b R=$(o).e("R");b 15=$(o).1T();15.e("V",$(o).e("V"));15.e("R",R);5(24(R)>0)1V($(15),R)})}',62,152,'||find|name||if||input|register_panel|||var||function|attr|this|form|trim||val||data|txt|||register|false||return|panel|form_tip|else|true|each|user_pwd_confirm|user_pwd|bind|form_err|user_mobile|bindfocus|email|city|bindblur|rel|query|user_name|sms_verify|option|html|verify_code|info|ipt|focus|lesstime|form_tip_clear|province|url|form_prefix|select|blur|mobile|field|city_id|value|_|ph_verify_btn|init_sms|divbtn|regionConf|click|length|bindsubmit|success|parent|status|POST|ajax_check_field|dataType|json|type|key|province_id|checkMobilePhone|new|showErr|ajax|div|settings_province_id|id|init_province|load_city|bindclick|tab|in|RegExp|reg|ui_select|refresh|current|reg_num|pwd|init_register_panel|test|for|ph_img_verify|serialize|showSuccess|href|jump|show|hide|submit|action|checkEmail|btn|location|formname|next|iconcode|init_sms_code_btn|verify|init_register_sms_btn|document|addClass||zA|log|removeClass|parseInt|Z0|button|change|live|ready|lk|9_|global|_ph_register_form|img|sms_ipcount|AJAX_URL|unique|disabled|Object|act|send_sms_code|form_success|IS_RUN_CRON|u9fa5|console|u4e00|ph_register'.split('|'),0,{}))
