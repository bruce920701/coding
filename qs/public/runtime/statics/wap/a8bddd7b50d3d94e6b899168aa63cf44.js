...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(A).x("w","#v",3(e,t,$u){y();h z=d E(\'.j-a-g\',{D:8,C:\'s\',B:F,l:8});$(".7").k("6",3(){h 5=d r();5.q="7";$.p({o:m,n:5,g:"R",X:"W",V:3(2){9(2.G==1){$(".i").T(\'7\').U("Z").b(2.4);$(".i-12").b(2.10);$(".11-4 .a Y").b(2.a)}f{$.S(2.4)}},})});$(".c").K("6");$(".c").J("6",3(){9(I==0){9(H=="L"){M.Q()}f{$.P.O(N,8)}}})});',62,65,'||obj|function|info|query|click|signin|true|if|score|html|ulogin|new||else|type|var|sign||live|grabCursor|INDEX_URL|data|url|ajax|act|Object|auto|pageId|page|scores_index|pageInit|on|init_auto_load_data|mySwiper|document|centeredSlides|slidesPerView|scrollbarHide|Swiper|false|status|app_index|is_login|bind|unbind|app|App|login_url|load|router|login_sdk|POST|alert|removeClass|find|success|json|dataType|em|span|sign_info|user|day'.split('|'),0,{}))
