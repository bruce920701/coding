...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(f).e(0(){5()});0 5(){$(".h").1("3",0(){$.i.j(c,{a:\'d\',b:\'g\',v:2,r:2,s:2,t:\'支付提示\',k:u,q:\'p\',l:0(){m();$("#n").1("3",0(){4.9=$(7).6("8")});$("#o").1("3",0(){4.9=$(7).6("8")})}})})}',32,32,'function|bind|false|click|location|init_buy_button|attr|this|url|href|boxid|contentType|PAY_TIP|pay_tip|ready|document|ajax|paybutton|weeboxs|open|width|onopen|init_ui_button|pay_done|pay_retry|wee|type|showCancel|showOk|title|450|showButton'.split('|'),0,{}))
