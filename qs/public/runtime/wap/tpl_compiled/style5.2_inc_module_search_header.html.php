...
<header class="bar bar-nav">
	<div class="m-search-header flex-box">
		...
		<?php else: ?>
		<a class="header-btn header-left iconfont" href="javascript:App.app_detail(1,0);">&#xe604;</a>
		<?php endif; ?>
...
<header class="bar bar-nav">
	<div class="m-search-header flex-box">
		<a class="header-btn header-left iconfont <?php if ($this->_var['back_url']): ?> go_back<?php else: ?> back <?php endif; ?>" href="#">&#xe604;</a>
		<a href="<?php
