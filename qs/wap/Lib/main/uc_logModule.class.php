...
class uc_logModule extends MainBaseModule
{
	...
	public function bdjl(){
        ...
        /** @var   @改变静态奖金的发放方式，下面不需要自动释放 $type
        ...
        */
        ...
        //$GLOBALS['tmpl']->assign('pages',$p);
        $user_avatar = get_abs_img_root(get_muser_avatar($user_info['id'],"big"))?:'';

        $GLOBALS['tmpl']->assign('user_avatar',$user_avatar);
        $GLOBALS['tmpl']->assign("user_info",$user_info);
        $GLOBALS['tmpl']->assign('data',$data);
        ...
        $GLOBALS['tmpl']->display("uc_log_bdjl.html");
        //echo json_encode($GLOBALS['tmpl']);
    }
	...
	public function jiangjin(){
        ...
        */
        ...
        $GLOBALS['tmpl']->display("uc_log_jiangjin.html");
        //echo json_encode($GLOBALS['tmpl']);
    }
	/**
	 * 互转积分
	...
	public function hzjf(){
        ...
        $data = array('page_title'=>"互转资产");

        //转账记录
        $type = '"active_code"';
        $sql = "select * from ".DB_PREFIX."translate_log where (id=".$user_info['id']." or to_id=".$user_info['id'].") and type=".$type."  order by time DESC";
        $translate_detail_active = $GLOBALS['db']->getAll($sql);
        ...
        $GLOBALS['tmpl']->assign('url',$url);
	    $GLOBALS['tmpl']->assign("no_nav",true); //无分类下拉
        $GLOBALS['tmpl']->assign("translate_detail",$translate_detail);
        $GLOBALS['tmpl']->assign('translate_detail_active',$translate_detail_active);
	    $GLOBALS['tmpl']->assign("data",$data); //title
	    $GLOBALS['tmpl']->display("uc_log_hzjf.html");
	    echo json_encode($GLOBALS['tmpl']);
	}
    ...
    */
	...
	public function hzjhm(){
        ...
        //转账记录
        $type = '"active_code"';
        $sql = "select * from ".DB_PREFIX."translate_log where id=".$user_info['id']." and type=".$type."  order by time DESC";
        $translate_detail = $GLOBALS['db']->getAll($sql);

	    $GLOBALS['tmpl']->assign("no_nav",true); //无分类下拉
	    $GLOBALS['tmpl']->assign("page_title","用户积分日志"); //title
        $GLOBALS['tmpl']->assign('translate_detail',$translate_detail);
	    $GLOBALS['tmpl']->display("uc_log_hzjhm.html");
	    //echo json_encode($GLOBALS['tmpl']);
	}
    ...
    public function do_translate_active_code()
    {
        ...
        $time = time();
        $num = $t_active_code;
        $msg = "您转账给用户".$t_user_info['user_name']." ".$num."结算码";
        $msg = '"'.$msg.'"';
        $sql = "insert into ".DB_PREFIX."translate_log(id,to_id,time,type,num,msg) values(".$user_id.','.$t_id.','.$time.','.$type.','.$num.','.$msg.")";
        $GLOBALS['db']->query($sql);
	...
	public function yjmx(){
	    ...
	    $GLOBALS['tmpl']->display("uc_log_yjmx.html");
        //echo json_encode($GLOBALS['tmpl']);
        //echo json_encode($GLOBALS['tmpl']);
	...
	public function bdzx(){
	    ...
	    //$GLOBALS['tmpl']->assign("no_nav",true); //无分类下拉
	    $GLOBALS['tmpl']->assign("page_title","用户积分日志"); //title
	    $GLOBALS['tmpl']->display("uc_log_bdzx.html");
	    //echo json_encode($GLOBALS['tmpl']);
	...
	public function dhzcjf(){
	    ...
	    //$GLOBALS['tmpl']->assign("no_nav",true); //无分类下拉
	    $GLOBALS['tmpl']->assign("data",$data); //title
	    $GLOBALS['tmpl']->display("uc_log_dhzcjf.html");
	    //echo json_encode($GLOBALS['tmpl']);
