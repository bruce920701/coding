...
class ajaxModule extends MainBaseModule
{
	...
	public function count_buy_total()
	{
        ...
        //if($reward==1){
		    $GLOBALS['tmpl']->assign("is_presell",$data['is_presell']);
		    $GLOBALS['tmpl']->assign("buy_type",$buy_type);
    		$GLOBALS['tmpl']->assign("feeinfo",$data['feeinfo']);
    		$GLOBALS['tmpl']->assign("deposit_money",$data['deposit_money']);
    		$GLOBALS['tmpl']->assign("discount_money",$data['discount_money']);
    		$GLOBALS['tmpl']->assign("left_price",$data['left_price']);
    ...
    public function scanqrcode(){
        ...
        $site = str_replace('http://', '', SITE_DOMAIN);
    ...
    public function verification_code(){
        ...
        $data['status']=1;
        $data['html'] = $GLOBALS['tmpl']->fetch("style5.2/inc/module/verification_code.html");
        ajax_return($data);
    }
