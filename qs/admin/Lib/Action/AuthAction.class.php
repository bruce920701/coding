...
class AuthAction extends BaseAction{
	...
	{		
		...
		if(OPEN_WEIXIN)
		{
			...
			{
				$config_file = APP_ROOT_PATH."system/adm_cfg/".APP_TYPE."/wxadmnode_platform_cfg.php";
			}
			else
			{
		...
		{
		    $config_file = APP_ROOT_PATH."system/adm_cfg/".APP_TYPE."/serviceadmnode_cfg.php";
		    $access_list = array_merge_admnode($access_list, $config_file);
		}
		
		if(IS_OPEN_AGENCY==0){
		    unset($access_list['Agency']);
		}
