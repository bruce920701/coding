...
class MIndexAction extends CommonAction{
	public function add()
	{
		...
		$nav_cfg=get_mobile_cfg($nav_cfg,1);
	...
	public function insert() {
		...
		$data['vice_name'] = trim($_POST['iconfont']);
		$data['desc'] = trim($_POST['iconcolor']);
		$data['iconbgcolor'] = trim($_POST['iconbgcolor']);
