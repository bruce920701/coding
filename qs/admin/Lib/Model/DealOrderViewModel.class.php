...
class  DealOrderViewModel extends ViewModel{
    public $viewFields = array(
        'DealOrder'=>array('id','order_sn','presell_type','is_presell_order','presell_discount_money','presell_deposit_money','type', 'total_price', 'consignee', 'pay_amount',  'create_time',  'pay_status',  'delivery_status',  'refund_status',  'order_status', 'region_lv2','region_lv3','region_lv4', 'deal_order_item', 'supplier_id', 'is_delete','ecv_money','youhui_money','distribution_id','distribution_id', '_type'=>'left'),
