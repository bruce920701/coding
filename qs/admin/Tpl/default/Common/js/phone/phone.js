var phone_field =self.name;
if(phone_field==''){
	phone_field='phone_description';
}
$(document).ready(function(){

	var admin_root = window.parent.admin_root;
	...
	var p_content = $("input[name='"+phone_field+"']",window.parent.document).val();
	if(typeof(p_content)!='undefined'){
		var re = new RegExp('src="./public',"g");	
		var content = p_content.replace(re,'src="'+app_root+'/public');
